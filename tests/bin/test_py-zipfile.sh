...
result=$($ZIPFILE_CMD create-archive "$archive" "$TEST_FILE" "$TEST_DIR")
...
result=$($ZIPFILE_CMD create-archive "$compressed_archive" "$TEST_FILE" --compress-level 9)
...
result=$($ZIPFILE_CMD --json list "$archive")
...
result=$($ZIPFILE_CMD --json info "$archive")
...
result=$($ZIPFILE_CMD --json find-member "$archive" "$TEST_FILE")
...
result=$($ZIPFILE_CMD --json find-member "$archive" "nonexistent.txt")
...
result=$($ZIPFILE_CMD --json get-member-info "$archive" "$TEST_FILE")
...
result=$($ZIPFILE_CMD create-archive "$exclude_archive" "$TEST_DIR" --exclude "*.txt")
...
result=$($ZIPFILE_CMD create-archive "$include_archive" "$TEST_DIR" --include "*.txt")
...
result=$($ZIPFILE_CMD create-archive "$password_archive" "$TEST_FILE" --password "testpass")
...
result=$($ZIPFILE_CMD create-archive "$comment_archive" "$TEST_FILE" --comment "Test archive")
...
result=$($ZIPFILE_CMD create-archive "$store_archive" "$TEST_FILE" --method store)
...
result=$($ZIPFILE_CMD create-archive "$deflate_archive" "$TEST_FILE" --method deflate)
...
result=$($ZIPFILE_CMD create-archive "$bzip2_archive" "$TEST_FILE" --method bzip2)
...
result=$($ZIPFILE_CMD create-archive "$lzma_archive" "$TEST_FILE" --method lzma)
...
result=$($ZIPFILE_CMD --json get-member-datetime "$archive" "$TEST_FILE")
